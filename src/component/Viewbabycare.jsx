...
function Viewbabycare() {
  const [userdata, setUserdata] = useState([]);
  useEffect(() => {

    axios.post('https://market.jprtechnosoft.com/api/getbabycareproductviewall')
      .then(res => {
  ...
  return (
    ...
    <div>
      ...
      {userdata.map((elem, index) => (
          <div style={{ float: 'left', marginLeft:'20px', margin: '2%',width:'290px'  }} className="cardItemsub" >
