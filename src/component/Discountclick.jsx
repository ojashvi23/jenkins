...
//     axios.post('http://13.126.77.1/api/get_product_by_categoryid',id)

//       .then(res => {
//         console.log("responce discount id", res);
...
//           <div style={{ float: 'left', margin: '2%' }} className="cardItemsub" >
...
//             </div>
//               <span style={{ color: 'green' }}><Cardincement /></span>
//           </div>
//         ))}
//       </div>
