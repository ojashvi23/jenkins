...
function Babycare(props) {
  ...
  useEffect(() => {
    ...
    axios.post('https://market.jprtechnosoft.com/api/getbabycareproduct')
      .then(res => {
        console.log('response api baby care', res);
  ...
  return (
    <>
      ...
      {userdata.map((elem, index) => (
          <div style={{ float: 'left', margin: '0.2%',width:'240px', height:"400px"}} className="cardItemsub" >
            ...
            <div style={{ marginTop: '10px', color: '#03A305', fontWeight: 'bold' }}>
              ...
              <span style={{ marginLeft: '10px' }}>{elem.discount_price} /- </span>
