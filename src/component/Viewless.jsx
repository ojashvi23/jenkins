...
<MDBRow>
                    <MDBCol md="12">
                        ...
                        Enjoy and share a healthy cup of Brooke Bond Red Label tea any time of the day and increase togetherness. 
                  ...
                  <p onClick={() =>{setReadMore(readMore)}}>View less</p>
                    </MDBCol>
                </MDBRow>
                </MDBContainer>
  ...
  const linkName=readMore?'view less':'View Detail '
  return (
<>
